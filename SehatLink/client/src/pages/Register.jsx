...
const Register = () => {
  ...
  const isValid = (fieldName) => {
    return (
      formData[fieldName] && (!errors[fieldName] || errors[fieldName] === "")
    );
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-500 mt-2">
            Join SehatLink for quality healthcare
          </p>
        </motion.div>
